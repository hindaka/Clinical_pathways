                    ...
                    ?>
                     <tr>
		              ...
		              <button type="submit" class="btn btn-success">Simpan</button>
						...
						<form action="sc_sectio_ksr_up.php" method="post">
							<div class="box">
								<div class="box-header">
									...
									<div class="row">
										<div class="col-xs-6">
											<div class="form-group">
												...
												<input type="hidden" name="id_asesmen" value="<?php echo $id_asesmen; ?>">
												<input type="number" name="biaya_riil" placeholder="Masukan Biaya Riil" class="form-control" value="<?php $title['biaya_riil'] ?>">
											</div>
											<div class="form-group">
