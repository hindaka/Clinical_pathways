...
//mysql data
$h2=mysql_query("SELECT * FROM clinicp WHERE id_clinicp!='1' AND oleh='$mem_id'");
$r2=mysql_fetch_row($h2);
}
?>
<!DOCTYPE html>
...
$hasile=mysql_query("SELECT * FROM pasien WHERE nomedrek='$nomedrek'");
$datane=mysql_fetch_array($hasile);
$nama=$datane["nama"];
$hasilku=mysql_query("SELECT * FROM clinicp WHERE id_clinicp='$id_clinicp'");
$dataku=mysql_fetch_array($hasilku);
$biayaklaim=$dataku["jumlahbiayak"];
$biayakformat=number_format($biayaklaim,0,".",".");
echo("
<tr>
    <td>$nomer</td>
	<td>$nomedrek</td>
    ...
    <td>$diagnosau</td>
    <td>$biayakformat</td>
    <td><a class=\"btn btn-success btn-s\" href=\"cpedit.php?id=$id_clinicp&nomedrek=$nomedrek\"><i class=\"fa fa-edit\"></i> Edit</a> <a class=\"btn btn-primary btn-s\" href=\"cpview.php?id=$id_clinicp&nomedrek=$nomedrek\" target=\"_blank\"><i class=\"fa fa-play-circle\"></i> Lihat</a></td>
</tr>
");
$nomer=$nomer+1;
}
