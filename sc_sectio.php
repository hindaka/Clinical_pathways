                ...
                <div class="table-responsive">
                  <table class="tabel-border" id="form_sc">
                    ...
                    <tr>
                      ...
                      <td colspan="3">output rekam medis</td>
                      <td colspan="2">Rujukan</td>
                      <td colspan="3">output rekam rujukan</td>
                    </tr>
                    <!-- row 2 -->
                    <tr>
                      <td>Nama Pasien</td>
                      <td colspan="3">output Nama Pasien</td>
                      <td colspan="2">Rencana Rawat</td>
                      <td colspan="3">output Rencana Rawat</td>
                    </tr>
                    <!-- row 3 -->
                    <tr>
                      <td>Tanggal Lahir</td>
                      <td colspan="3">Output Tanggal lahir</td>
                      <td colspan="2">Berat Badan</td>
                      <td colspan="3">Output Berat Badan</td>
                    </tr>
                    <!-- row 4 -->
                    <tr>
                      <td>Jenis Kelamin</td>
                      <td colspan="3">Output Jenis Kelamin</td>
                      <td colspan="2">Tinggi Badan</td>
                      <td colspan="3">Output Tinggi Badan</td>
                    </tr>
                    <!-- row 5 -->
                    <tr>
